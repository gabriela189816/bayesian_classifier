...
### 
# plt.figure(1)
# plt.plot(c1_x1_sorted, norm.pdf(c1_x1_sorted, c1_mean_x1, c1_des_x1), label='$w_1$')
...
# plt.figure(2)
# plt.plot(c1_x2_sorted, norm.pdf(c1_x2_sorted, c1_mean_x2, c1_des_x2), label='$w_1$')
...
# plt.figure(3)
# plt.plot(c1_x3_sorted, norm.pdf(c1_x3_sorted, c1_mean_x3, c1_des_x3), label='$w_1$')
...
# plt.figure(4)
# plt.plot(c1_x4_sorted, norm.pdf(c1_x4_sorted, c1_mean_x4, c1_des_x4), label='$w_1$')
